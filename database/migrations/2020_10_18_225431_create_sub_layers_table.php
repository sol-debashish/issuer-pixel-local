...
class CreateSubLayersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_layers', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('layer_id')->unsigned();
            ...
            $table->foreign('layer_id')->references('id')->on('layers')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('sub_layers');
    }
}
