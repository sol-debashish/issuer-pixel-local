...
class CreateDecksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('decks', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('sub_layer_id')->unsigned();
            ...
            $table->index(['sub_layer_code']);
            $table->foreign('sub_layer_id')->references('id')->on('sub_layers')->onDelete('cascade')->onUpdate('cascade');
