...
class CreateSubFloorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_floors', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('floor_code', 32)->nullable();
    ...
    {
        Schema::dropIfExists('sub_floors');
    }
}
