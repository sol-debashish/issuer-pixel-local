...
class CreateBasementsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('basements', function (Blueprint $table) {
            ...
            $table->bigInteger('sub_floor_id')->unsigned();
            ...
            $table->index(['sub_floor_code']);
            $table->foreign('sub_floor_id')->references('id')->on('sub_floors')->onDelete('cascade')->onUpdate('cascade');
