...
class CreateMinesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('mines', function (Blueprint $table) {
            ...
            $table->bigInteger('sub_basement_id')->unsigned();
            ...
            $table->index(['sub_basement_code']);

            $table->foreign('sub_basement_id')->references('id')->on('sub_basements')->onDelete('cascade')->onUpdate('cascade');
