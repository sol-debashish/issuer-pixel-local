...
class CreateShareholderNumbersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('shareholder_numbers', function (Blueprint $table) {
            $table->id();
        ...
        DB::table('shareholder_numbers')->insert([
    ...
    {
        Schema::dropIfExists('shareholder_numbers');
    }
}
