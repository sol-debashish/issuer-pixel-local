  ...
  TagsInput.prototype = {
    ...
    build: function(options) {
            ...
            if (doGetCaretPosition($input[0]) === 0) {
              ...
              if (prev.length) {
                if (self.options.editOnBackspace === true) {
                  ...
                  var keyword= prev.data('item');
                  var node_id = $("#node_id_for_keyword").val();
                  var keyword_type = $("#keyword_type").val();
                  $.confirm({
                      title: 'Confirm!',
                      content: "Are you sure want to delete this information?",
                      columnClass: 'medium',
                      type: 'orange',
                      typeAnimated: true,
                      buttons: {
                          yes: {
                              ...
                              action: function () {
                                  ...
                                  deleteKeyword(keyword,node_id,keyword_type);
                              }
                          },
                          cancel: function () {
      ...
      self.$container.on('click', '[data-role=remove]', $.proxy(function(event) {
          var keyword= $(event.target).closest('.badge').data('item');
          var node_id = $("#node_id_for_keyword").val();
          var keyword_type = $("#keyword_type").val();
          $.confirm({
              title: 'Confirm!',
