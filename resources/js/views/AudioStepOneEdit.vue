    ...
    <section class="dashboard pt-0">
        <div class='row'>
            <div class='col-md-12 grid-margin'>
                <h4 class="pb-2 text-theme-dark-blue">Audio Classifications</h4>
                <div class='card'>
                    <div class='card-body'>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <!--<div class="row mt-3">
                                <div class="col-md-8 offset-4">
                                    ...
                                    <button @click.prevent="updateAudioTaxonomy" class="btn btn-back-next float-right">
                                        Update
                                    </button>
                                </div>
                            </div>-->
    ...
    export default {
        ...
        methods: {
            updateAudioTaxonomy() {
                ...
                Questionnnaire.saveStep1AudioData(this.audioTaxoFormData, this.$route.params.fileId)
                    .then((response) => {
