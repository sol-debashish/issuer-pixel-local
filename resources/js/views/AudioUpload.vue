<template>
    <section class="dashboard pt-0 audio-upload-section">
        <div class='row'>
            <div class="col-md-12 grid-margin text-center">
                <h4 class="text-theme-dark-blue font-weight-bold" >Audio upload</h4>
                <div class="d-block mb-2 fs-16 font-weight-bold  text-theme-dark-blue">
                        ...
                        <div class="col">
                            <div class="large-12 columns mx-auto">
                                ...
                                <div id="drag-area" class="panel drop-zone drag-area">
                                    ...
                                    <header class="text-theme-dark-blue" v-show="!resumbleUploading || resumbleUploadCompleted">Drag and drop audio to upload</header>
...
<!--                                        <img src="images/cloud-upload.png" alt="Media Upload">-->
                                    ...
                                    <div class="mt-2 mb-2" v-show="!resumbleUploading || resumbleUploadCompleted">
                                        <p class="text-theme-dark-blue fs-16">Issuer Pixel supports audio files of type m4a,flac,mp3,wav,wma,acc</p>
                                    </div>
                ...
                <div class="text-center">
                    <button type="button" :disabled='audioUploadIsDisabled'
        ...
        this.r.on('fileAdded', function (file, event) {
            var template =
                '<div class="single-video" data-uniqueid="' + file.uniqueIdentifier + '">' +
                    ...
                    '<div class="large-6 right deleteFile"><i class="far fa-times-circle"></i></div>' +
                '</div>'
