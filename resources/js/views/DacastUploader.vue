    ...
    export default {
        ...
        mounted : function() {
            ...
            this.r = new Resumable({
                ...
                query: {_token:  document.querySelector('meta[name="csrf-token"]').content, title : this.getTitle(), type: 'dacast', Accept:'application/json'}
            });
            ...
            this.r.on('fileSuccess', function(file, message){
                ...
                $('.alert-box').addClass('alert-success').html("Uploading Done. Go to  <a href='/dacast-video'>video</a>");
                window.onbeforeunload = function () {
