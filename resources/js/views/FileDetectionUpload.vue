<template>
    <section class="dashboard pt-0 media-file-upload-section">
        <div class='row'>

            <div class="col-md-12 grid-margin text-center font-weight-bold">
                <h4 class="text-theme-dark-blue font-weight-bold" >Video/Audio upload</h4>
            ...
            <div class='col-md-8 offset-md-2 grid-margin'>
                            ...
                            <div class="large-12 columns mx-auto">
                                <div id="drag-area" class="panel drop-zone drag-area">
                                    <div v-if="resumbleUploading && !resumbleUploadCompleted" class="p-3 mb-2 bg-danger text-white">
                                        ...
                                        <header class="text-theme-dark-blue" v-show="!resumbleUploading || resumbleUploadCompleted">Drag and drop video/audio to upload</header>
                                        ...
                                        <div class="mt-2 mb-2" v-show="!resumbleUploading || resumbleUploadCompleted">
                                            <p class="text-theme-dark-blue fs-16">Issuer Pixel supports webm, mkv, flv, vob, avi, mov, wmv, mp4, m4p, mpg, mpeg,
                                                m4a, flac, mp3, wav, wma, acc</p>
                                        </div>
                ...
                <div class="text-center">
                    <button type="button" :disabled='uploadIsDisabled'
                            class="btn btn-secondary px-5 video-upload-button" @click="startUpload">
                        <i class="fas fa-cloud-upload-alt"></i>  Upload Video/Audio
                    </button>
    ...
    export default {
        ...
        mounted: function () {
            ...
            this.r.on('fileAdded', function (file, event) {
                var template =
                    '<div class="added-media-file" data-uniqueid="' + file.uniqueIdentifier + '">' +
