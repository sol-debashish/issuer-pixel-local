                ...
                <div class="table-responsive">
                    <div class="search mb-4">
                        <form action="" id="filter_form">
                            <div>
                                ...
                                <select class="form-control" id='hierarchyType'>
                                    <option value=''>-- Select --</option>
                                    @foreach($hierarchyType as $hierarchyKey => $hierarchyValue)
                                        <option value='{{$hierarchyValue}}'>{{$hierarchyValue}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div>
                    ...
                    <table id="nodeStatistics" class=" table table-bordered table-striped table-hover" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <th style="width: 10%">Type of Change</th>
                            <th style="width:8%">Content Type</th>
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTable = $('#nodeStatistics').dataTable({
                ...
                "scrollCollapse": true,
                "ajax": {
                    'url' : "{{route('admin.hierarchy.suggestion')}}",
                    'data': function (data) {
                        ...
                        data.searchByHierarchyType = hierarchyType;
        ...
        $('.modal-footer').on('click', '.change-status-btn', function (){
            ...
            $.ajax({
                type: 'post',
                url: "{{ route("admin.hiearchy.suggestion.accept.reject") }}",
                data: {
