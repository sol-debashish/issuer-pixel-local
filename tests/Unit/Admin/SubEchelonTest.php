...
class SubEchelonTest extends TestCase
{
    /**
    ...
    public function test_a_sub_echelon_has_tier()
    {
        /*create industry*/
        ...
        $this->assertTrue($subEchelon->tier->contains($tier));
        $this->assertInstanceOf('Illuminate\Database\Eloquent\Collection', $subEchelon->tier);
    }

    public function test_sub_echelon_table_has_expected_columns()
    {
        $this->assertTrue(
            Schema::hasColumns('sub_echelons', [
                'id',
                'echelon_id',
                'code',
                'industry_code',
